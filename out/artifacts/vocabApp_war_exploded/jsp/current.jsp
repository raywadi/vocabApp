...
<head>
    ...
    <script type="text/javascript">
        ...
        function archive_word(domObject) {
            var parent = $(domObject).parent();
...
<div id="content" onmouseover="show()" onmouseout="hide()">
    ...
    <%
        ...
        String queryString = "select from " + Words.class.getName() + " where email == '"
                + user.getEmail() + "' && archived == 'false' order by date desc";
    ...
    <div class="wordList" id="wordList">
        ...
        <div class="word" title="<%=shortHand%>" align="center">
            ...
            <span class="image" onclick="archive_word(this)"><img align="left" height="16" width="16" src="/images/archive.png" alt="archive" title="Archive"/></span>
        </div>
        <%
            }
        %>
